...
$(function () { 
  $.smartbanner({ title:'SMFCU APP', author: 'SMFCU.org' }) })
//ENTER THE APP IDS FROM APPLE STORE AND ANDROID PACKAGE IDS FROM GOOGLE PLAY STORE HERE

var iPhoneID = '1071431286';
var iPadID = '1071431286';
var AndroidPhoneID = 'com.camsbycbs.android.ib.smfedcu';
var AndroidTabletID = ' com.camsbycbs.android.ib.smfedcu ';
...
$('head').append("<link rel='apple-touch-icon' href='https://oc-pfcu.squarespace.com/s/icon.png'>");
$('head').append("<link rel='android-touch-icon' href='https://oc-pfcu.squarespace.com/s/icon.png' />");
